...
public class JFrmLogin extends javax.swing.JFrame {
    ...
    private void jBtnOk_mslActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOk_mslActionPerformed
        ...
        UsuarioKvm usuarios = new UsuarioKvm(); // Cria uma instância da classe UsuarioKvm
        ...
        System.out.println("nome: " + usuarios.getNomeKvm()); // Tenta imprimir no console o nome do objeto 'usuarios', que provavelmente será nulo.
        System.out.println("senha: " + usuarios.getSenhaKvm()); // Tenta imprimir no console a senha do objeto 'usuarios', que provavelmente será nula.
