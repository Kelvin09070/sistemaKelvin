...
public class JDlgUsuarioPesquisa extends javax.swing.JDialog {
    ...
    private UsuarioControle usuarioControle;//invoca o clientes controle para controla-lo
    /**
    ...
    public JDlgUsuarioPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        usuarioControle = new UsuarioControle();//invoca o clientes controle para controla-lo
        Usuario_DAO usuario_DAO = new Usuario_DAO();
        List lista = usuario_DAO.listAll();
        usuarioControle.setList(lista);
        jTable1Msl.setModel(usuarioControle);
    ...
    private void jBtnOKMslActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOKMslActionPerformed
        ...
        UsuarioKvm usuarios = usuarioControle.getBean(rowSel);
        jDlgUsuario.beanView(usuarios);
        jDlgUsuario.pesquisado = true;
        setVisible(false);
